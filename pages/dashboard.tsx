...
import SpaceBackground from '../components/SpaceBackground'; // Import our new background

// ... (backdropVariants and modalVariants are the same)
...
export default function DashboardPage() {
  ...
  return (
    <div className="relative">
      ...
      {/* AnimatePresence and modal logic remain the same */}
      <AnimatePresence>
        {selectedPost && (
          <motion.div 
