...
export default function HomePage() {
  ...
  useEffect(() => {
    // Globe points logic is preserved
  ...
  // This is the simple success handler your form expects.
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center p-4">
        {isPosting ? (
          ...
          <>
            ...
            <button onClick={handleShareClick} className="bg-blue-600 ...">
              Share a Thought
            </button>
            <Link href="/feed"><span className="absolute bottom-10 ...">(or, Explore the Feed)</span></Link>
          </>
        )}
      </div>
    </div>
